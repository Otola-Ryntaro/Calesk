...
**実装タスク**:
- [x] プレビュー画像の最大サイズ設定（640x360）✅ **2026-02-04完了**
- [x] `PreviewWidget.set_image()` で自動縮小 ✅ **2026-02-04完了**
- [x] 元画像の保持を最小限に（パスのみ保持）✅ **2026-02-04完了**
- [ ] キャッシュディレクトリの作成（`~/.calendar_wallpaper/cache/`）（将来拡張）
- [x] メモリ使用量のテスト ✅ **2026-02-04完了**
  - PreviewWidget: 14テスト全合格（+3テスト追加）
  - 全体: 106テスト全合格
  - **コードレビュー**: スコア9/10、評価"APPROVED"

**実装内容**:
- `_original_pixmap`を`_preview_pixmap`に変更（最大640x360）
